...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB12     ------> ADC1_IN11
    */
    GPIO_InitStruct.Pin = ADC_I_CHASSIS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_I_CHASSIS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(ADC_I_CHASSIS_GPIO_Port, ADC_I_CHASSIS_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB2     ------> ADC2_IN12
    */
    HAL_GPIO_DeInit(ADC_V_CAP_GPIO_Port, ADC_V_CAP_Pin);

    HAL_GPIO_DeInit(ADC_I_CAP_GPIO_Port, ADC_I_CAP_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(ADC_V_MOTOR_GPIO_Port, ADC_V_MOTOR_Pin);
