...
{
    incremental_pid_init(&pid_cap_voltage_h, 1.35f, 0.0005f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
    incremental_pid_init(&pid_cap_voltage_l, 1.2f, 0.0004f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
    incremental_pid_init(&pid_power, 0.005f, 0.004f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
