...
{
    incremental_pid_init(&pid_cap_voltage_h, 1.5f, 0.004f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
    incremental_pid_init(&pid_cap_voltage_l, 1.0f, 0.008f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
    incremental_pid_init(&pid_power, 0.004f, 0.004f, 0, -CAP_CURRENT_MAX, CAP_CURRENT_MAX);
